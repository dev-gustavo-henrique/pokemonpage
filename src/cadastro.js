...
//**** Event of keyup for field input nome
nome.addEventListener("keyup", () => {
    if (nome.value.length <= 3) {
        //***
        labelNome.setAttribute("style", "color: red");
        labelNome.innerHTML = `
            <strong>Nome *Insira no minimo 3 caracteres</strong>
        `;
...
//**** Event of keyup for field input usuario
usuario.addEventListener("keyup", () => {
    if (usuario.value.length <= 4) {
        //***
        labelUsuario.setAttribute("style", "color: red");
        labelUsuario.innerHTML = `
            <strong>Usuario *Insira no minimo 5 caracteres</strong>
        `;
...
//**** Event of keyup for field input senha
senha.addEventListener("keyup", () => {
    if (senha.value.length <= 4) {
        //***
        labelSenha.setAttribute("style", "color: red");
        labelSenha.innerHTML = `
            <strong>Usuario *Insira no minimo 6 caracteres</strong>
        `;
...
//**** Event of keyup for button confirme senha
confirmeSenha.addEventListener("keyup", () => {
    if (senha.value !== confirmeSenha.value) {
        ...
        labelConfirmeSenha.innerHTML = `
            <strong>Confirmar Senha *As senhas não conferem</strong>
        `;
...
//**** Event of click for element btn
...
//**** Event of click for button confirme
